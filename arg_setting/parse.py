...
from dataset.data_selection import METRIC_CHECKPOINT_INFO
...
def Spatio_temporal_setting_s(setting_file, track=None):
    ...
    setting_dict["Task"]["metric_kwargs"]["target_length"] = (
        setting_dict["Task"]["target_length"] if "val_length" not in setting_dict["Task"] else setting_dict["Task"]["val_length"]
    )
